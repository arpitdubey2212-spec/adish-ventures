  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
            ...
            {products.map((product, idx) => {
              ...
              <div key={product.id} className="border-2 border-adish-beige rounded-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-8">
                  ...
                  <p className="text-adish-green text-lg mb-6">{product.description}</p>

                  {/* Specs */}
                  <div className="bg-adish-beige p-6 rounded-lg mb-6">
                    <h3 className="font-bold text-adish-dark mb-4">Specifications</h3>
                  ...
                  {/* Full Description */}
                  <div className="mb-8 p-4 bg-white border border-adish-beige rounded-lg">
                    <p className="text-adish-green text-sm leading-relaxed whitespace-pre-line">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-adish-green text-sm uppercase tracking-wide">Price</p>
                      <p className="text-4xl font-bold text-adish-gold">₹{product.price}</p>
                    </div>
                    <button
                      onClick={() => handleAddToCart(product.id, product.name, product.price)}
                      className={`px-8 py-4 rounded-lg font-bold transition-colors flex items-center gap-2 ${
          ...
          <div className="mt-20 mb-16">
            <h2 className="text-3xl font-serif font-bold text-adish-dark mb-12 text-center">
              Choose Your Optimal Format
            </h2>

            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white border-2 border-adish-beige rounded-lg p-8">
                <h3 className="text-2xl font-bold text-adish-dark mb-6">Cordyceps Potency Powder</h3>
                ...
                <div>
                  <h4 className="font-bold text-adish-dark mb-3">Consumption Method:</h4>
                  <p className="text-adish-green">Mix 1-2 tsp daily into your favorite beverage. Traditional preparation method honors centuries of use.</p>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-adish-beige rounded-lg p-8">
                ...
                <div>
                  <h4 className="font-bold text-adish-dark mb-3">Consumption Method:</h4>
                  <p className="text-adish-green">Place 10-20 drops under tongue daily. Sublingual delivery bypasses digestion for rapid, full bioavailability.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Bundle Offer */}
          <div className="mt-20 bg-gradient-to-r from-adish-gold to-adish-light-gold p-12 rounded-lg">
            <div className="max-w-3xl">
              <h3 className="text-3xl font-serif font-bold text-adish-dark mb-4">
                Bundle & Save
              </h3>
              <p className="text-adish-dark mb-6 text-lg">
                Get both Powder and Tincture for ₹1,800 (Save ₹200)
              </p>
              <button className="bg-adish-dark text-white px-8 py-4 rounded-lg font-bold hover:bg-adish-green transition-colors">
                Buy Bundle
              </button>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-adish-beige">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-serif font-bold text-adish-dark text-center mb-12">
            Why Choose Adish Ventures?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg">
              <div className="text-4xl font-bold text-adish-gold mb-4">🌿</div>
              <h3 className="text-xl font-bold text-adish-dark mb-3">Pure Science</h3>
            ...
            <div className="bg-white p-8 rounded-lg">
              <div className="text-4xl font-bold text-adish-gold mb-4">⚡</div>
              <h3 className="text-xl font-bold text-adish-dark mb-3">Performance First</h3>
              <p className="text-adish-green">
            ...
            <div className="bg-white p-8 rounded-lg">
              <div className="text-4xl font-bold text-adish-gold mb-4">🎯</div>
              <h3 className="text-xl font-bold text-adish-dark mb-3">Hyper-Targeted</h3>
              <p className="text-adish-green">
